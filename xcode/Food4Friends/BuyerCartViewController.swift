    ...
    class BuyerCartViewController: UIViewController {
        ...
        func populatePage() {
            self.ItemName.text = "Purchased: " + self.descrip
            self.ServingsPurchased.text = "Servings Purchased: " + String(servings)
            self.TimeRemaining.text = "Time Remaining: " + self.endTime
        }
